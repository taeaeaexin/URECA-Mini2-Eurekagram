...
import com.gram.eureka.eureka_gram_user.dto.LoginRequestDto;
import com.gram.eureka.eureka_gram_user.dto.LoginResponseDto;
...
public class LoginController {
    ...
    public BaseResponseDto<LoginResponseDto> login(@RequestBody LoginRequestDto loginRequestDto) {
        ...
        try {
            ...
            // 인증 성공 시 JWT 토큰 생성
            String token = jwtUtil.generateToken(authentication.getName(), Role.ROLE_USER.getLabel());
